...
const Footer = ({ copyrightText = "©2025 RESURGE – All Rights Reserved" }) => {
  return (
    <footer className="bg-[#1A1A1A] text-gray-200 px-4 py-6 space-y-6">
      {/* Logo */}
      <div>
        <img src={resurgeLogo} alt="Resurge logo" className="h-10 w-auto" />
      </div>
      ...
      <div className="space-y-1 text-sm">
        ...
        <div className="flex items-center space-x-2">
          ...
          <a href="mailto:resurge.fun@gmail.com" className="hover:underline">
